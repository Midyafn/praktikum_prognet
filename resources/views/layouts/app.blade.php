            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <div class="d-flex">
                        ...
                        <div class="pl-3 ml-3 pt-2" style="border-left:1px solid rgba(0, 0, 0, 0.5); font-size:1.5rem;">{{ config('app.name', 'ShopIn') }}</div>
                    </div>
                </a>
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    ...
                    <div class='col-md-6 col-sm-12 copyright'>
                        <p>Praktikum Prognet kelompok 18 &copy; 2021</p>
                    </div>
